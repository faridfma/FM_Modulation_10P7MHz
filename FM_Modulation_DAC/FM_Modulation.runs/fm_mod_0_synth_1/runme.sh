...
HD_PWD='C:/Users/fmabrouk/Documents/GitHub/DDS_FM_Transmitter_100Hz _DAC_2020/FM_Modulation_DAC/FM_Modulation.runs/fm_mod_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fm_mod_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fm_mod_0.tcl

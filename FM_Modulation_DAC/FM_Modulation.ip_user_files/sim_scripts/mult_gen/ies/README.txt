...
#
# Generated by export_simulation on Wed Apr 15 15:24:00 -0700 2026
#
################################################################################
...
'-reset_run' switch to the './mult_gen.sh' script.

./mult_gen.sh -reset_run
...
./mult_gen.sh -noclean_files

For more information on the script, please type './mult_gen.sh -help'.

...
#
# Generated by export_simulation on Thu Apr 16 14:03:13 -0700 2026
#
################################################################################
...
'-reset_run' switch to the './fm_mod_0.sh' script.

./fm_mod_0.sh -reset_run
...
./fm_mod_0.sh -noclean_files

For more information on the script, please type './fm_mod_0.sh -help'.
